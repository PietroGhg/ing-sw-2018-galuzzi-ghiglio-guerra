...
/*
    ...
    Controllo?      8: RunningPliers -> 0: DraftPool index, 1: cell row, 2: cell col; controllo che sia il primo turno, far saltare il secondo turno
    ...
    Parametri?      12: TapWheel -> 0: RoundTrack number, 1: RoundTrackindex,
