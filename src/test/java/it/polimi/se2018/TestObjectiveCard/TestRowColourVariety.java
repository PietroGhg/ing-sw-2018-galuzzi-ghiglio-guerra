...
/**
 * Test for PublicObjectiveCard RowColourVariety
 * @author Leonardo Guerra
 */

public class TestRowColourVariety {
    private WPC wpc;
    private WPC wpc2;
    private WPC wpc3;
    ...
    public void setUp() {
        ...
        wpc2 = new WPC();
        wpc2.setDie(0, 0, new Die(4, Colour.PURPLE));
        ...
        wpc2.setDie(2, 3, new Die(3, Colour.YELLOW));
        wpc2.setDie(2, 4, new Die(3, Colour.GREEN));
        wpc2.setDie(3, 0, new Die(3, Colour.GREEN));
        wpc2.setDie(3, 1, new Die(3, Colour.YELLOW));
        wpc2.setDie(3, 2, new Die(3, Colour.RED));
        wpc2.setDie(3, 3, new Die(3, Colour.BLUE));
        wpc2.setDie(3, 4, new Die(3, Colour.PURPLE));
    ...
    @Test
    public void testWpc() {
        RowColourVariety r = new RowColourVariety();
        RowColourVariety r2 = new RowColourVariety();
        RowColourVariety r3 = new RowColourVariety();
